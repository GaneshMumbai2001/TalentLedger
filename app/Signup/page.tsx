              ...
              <div className="  rounded-2xl md:mx-80 mx-7 px-5 md:px-20  ">
                <div className="flex flex-col  items-center space-y-5 py-6 rounded-lg bg-white justify-center mt-5 ">
                  ...
                  <div className=" flex justify-center items-center flex-col space-y-5">
                    <label className="text-[#747474]">
                      Verifier your identity if your from India!
                    </label>
                    ...
                    >
                      ...
                      <div>
                        ...
                        <p className="text-[#000000] opacity-40">
                          Use a PDF, Word doc, or rich text file – make sure
                          it’s 5MB or less
                        </p>
                      </div>
                        ...
                        <div className="flex justify-center items-center w-full ">
                          ...
                          <div className="flex-1 px-5">
                            <p className="text-black text-start py-1 opacity-40">
                              Hashed Resume:{" "}
                              {selectedFile?.IpfsHash?.slice(0, 5)}
                            </p>
                      ...
                      <div className="mt-4 flex space-x-3">
                        ...
                        >
                          <span className="flex justify-center space-x-2">
                            <AiOutlinePlus className="mt-1" /> Add Work
                            Experience
                          </span>
                        </button>
                        {experience.id > 1 && (
              ...
              {academicProjects?.map((project, index) => (
                ...
                >
                  ...
                  <div className=" flex justify-center">
                    ...
                    >
                      <span className="flex justify-center space-x-2">
                        <AiOutlinePlus className="mt-1" /> Add Academic/
                        Personal Projects
                      </span>
                    </button>
                    {index !== 0 && (
