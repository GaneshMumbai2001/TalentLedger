...
function Page() {
  ...
  const shareURL = `https://gigshub.xyz/${did.replace(/[^a-z0-9]/gi, "")}`;
  ...
  return (
    <div className="bg-black bg-[url('../assets/linebar.png')] bg-cover  bg-no-repeat min-h-screen pb-10 ">
      ...
      <div className="mt-5  text-white">
        {resumeHave && (
          <div>
            <div className="flex lg:flex-row items-center md:items-start flex-col lg:mx-7 md:mx-5 2xl:mx-10">
              <div className="bg-[url('../assets/profilecard.png')] mx-5 my-5 mb-20 md:mb-0 rounded-2xl bg-cover bg-no-repeat h-[500px] md:h-[540px] border-4 border-black md:w-[380px] px-4 md:mr-5  2xl:mr-10   ">
                <div className="flex flex-col items-center ">
                  ...
                  <div className="bg-[#161F2D] absolute mt-[180px]  2xl:mt-[250px] xl:left-28 2xl:left-40 px-2 py-2 border-4 inline-block rounded-2xl border-[#121212]">
                ...
                <div className="flex justify-center mt-2 ">
                  <Link shallow href="/EditProfile">
                    <button className="px-5 rounded-lg py-2 flex items-center  bg-[#3498DB]">
