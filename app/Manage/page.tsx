...
function page() {
  ...
  const categories = ["Upcoming", "Ongoing", "Cancelled", "Completed"];
  const totalEarnings = initialGigs.reduce(
    (acc, gig) => acc + parseFloat(gig.total.replace(/[$,]/g, "")),
    0
  );
      ...
      <div className="px-20 mt-8">
        ...
        <div className="mt-8 flex space-x-6">
          <div className="bg-[#FBF4EE] w-56 p-6 rounded-lg">
            ...
            <p className="text-[#747474]">Total Earnings</p>
          </div>
          <div className="bg-[#FBF4EE] w-56 p-6 rounded-lg">
            <p className="text-2xl font-bold">{totalGigs}</p>
            <p className="text-[#747474]">Gigs</p>
          </div>
          <div className="bg-[#FBF4EE] w-56 p-6 rounded-lg">
            <p className="text-2xl font-bold">{cancelledGigs}</p>
            <p className="text-[#747474]">Cancelled</p>
          </div>
          <div className="bg-[#FBF4EE] w-56 p-6 rounded-lg">
